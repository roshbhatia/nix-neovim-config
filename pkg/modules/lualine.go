...
// LualineModule configures the nvim-lualine statusline.
type LualineModule struct{}

// NewLualineModule constructs a new LualineModule.
func NewLualineModule() *LualineModule {
   return &LualineModule{}
}

// Name returns the module name.
func (m *LualineModule) Name() string {
   return "lualine"
}

// Setup runs the lualine setup code via Lua.
func (m *LualineModule) Setup(ctx *core.Context) error {
   cmd := `lua << EOF
local diagnostics = {
  "diagnostics",
